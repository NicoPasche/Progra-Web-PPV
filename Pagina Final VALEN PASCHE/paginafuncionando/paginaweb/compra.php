   ...
   if ( isset( $_SESSION['id'] ) ) 
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST")
        ...
        <div class="search-field" >
                ...
                <div class="titulo" align="center">GRACIAS POR LA COMPRA:</div>

                <div class="ubicacion" align="center">
                    
                    <div>
                     <h4> 
                     La informacion de la compra se le enviara al mail. 
                        </h4>
                    </div>
                ...
                <div class="tipo" align="center">
                    <div>
                        <h4> 
                        Para seguir comprando dirigase a "HOME".
                        </h4>
                    </div>
                </div>
                ...
                <div class="habitaciones" align="center">
                    <div>
                        <h4>
                        Para ver sus compras dirigase a su perfil y seleccione "Mis Compras".
                        </h4>
                    </div>
                </div>
