...
<!-- Start Header Area -->
			...
			<header  style="position: relative; top: -10px;">
				...
				{
					$escribir="* Las publicaciones compradas y/o publicadas por usted no apareceran en el siguiente listado.";
				?>
					<div class="topnav2">
				...
				{
					$escribir="* Las publicaciones compradas no apareceran en el siguiente listado.";
				?>
